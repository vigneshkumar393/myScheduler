...
public class BMySchedulerPointDiscoveryLeaf
  extends BNPointDiscoveryLeaf
{
//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $com.mayvel.myScheduler.point.BMySchedulerPointDiscoveryLeaf(1643154273)1.0$ @*/
/* Generated Mon May 12 15:27:40 IST 2025 by Slot-o-Matic (c) Tridium, Inc. 2012-2025 */
  ...
  public static final Type TYPE = Sys.loadType(BMySchedulerPointDiscoveryLeaf.class);

  //endregion Type

//@formatter:on
//endregion /*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
  public BMySchedulerPointDiscoveryLeaf()
  {
  }
...
//    }
  ...
  public void updateTarget(BComponent target)
  {
    ...
    BMySchedulerProxyExt pext = new BMySchedulerProxyExt();
  ...
  public boolean isExisting(BComponent target)
  {
    ...
    BControlPoint cp = (BControlPoint) target;
    BMySchedulerProxyExt pext = (BMySchedulerProxyExt) cp.getProxyExt();
    //
