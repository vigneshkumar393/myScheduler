package com.mayvel.myScheduler.utils;

import com.mayvel.myScheduler.Const.Consts;
import com.mayvel.myScheduler.component.SchedulerHelper;
...
public class Generic {
    ...
    public static String buildRecordToString(BAlarmRecord record) {
        Map<String, String> mapData = SchedulerHelper.convertToMap(record);
